...
parser.add_argument("--pth_dirs", default=['SIRST3/ACM_full.pth.tar','SIRST3/ACM_LESPS_centroid.pth.tar','SIRST3/ACM_LESPS_coarse.pth.tar',
                                           ...
                                           'GaborDNANet_LESPS_coarse_400.pth.tar','GaborDNANet_LESPS_coarse_390.pth.tar','GaborDNANet_LESPS_coarse_330.pth.tar',
                                           'GaborDNANet_LESPS_coarse_285.pth.tar','GaborDNANet_LESPS_coarse_140.pth.tar'], 
