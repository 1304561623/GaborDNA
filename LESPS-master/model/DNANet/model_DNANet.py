...
class GaborConv2d(_ConvNd):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 padding = None, dilation=1, groups=1, bias=False, padding_mode='zeros'):
...
class DNANet(nn.Module):
    def __init__(self, num_classes=1,input_channels=1, block=Res_CBAM_block, num_blocks=[2, 2, 2, 2], nb_filter=[16, 32, 64, 128, 256], deep_supervision=True, mode='test'):
        ...
        self.g0=GaborConv2d(input_channels,input_channels,kernel_size=(11,11))
