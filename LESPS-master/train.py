...
parser.add_argument("--model_names", default=['DNANet'], nargs='+', 
                    help="model_name: 'ACM', 'ALCNet', 'DNANet','GaborDNANet'")                 
...
if __name__ == '__main__':
    for dataset_name in opt.dataset_names:
        ...
        for model_name in opt.model_names:
            ...
            opt.f = open(opt.save + '/' + opt.dataset_name + '_' + opt.model_name + '_LESPS_' + opt.label_type + '.txt', 'w')#+ '_' + (time.ctime()).replace(' ', '_').replace(':', '_') + '.txt', 'w')
